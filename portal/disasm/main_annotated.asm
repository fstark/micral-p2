...
apply_reloc:
	...
	ld b,004h		; 4 word pairs per mask byte
reloc_word:
...
stream_has_bytes:
	...
	ld hl,000ffh		; 255 bytes available
...
read_sector_lba:
	...
	ld d,010h		; 16-bit division (16 iterations)
div_loop:
...
; BLOCK 'str_floppy_params' (start 0xfafd end 0xfb03)
floppy_params:
...
; ============================================================
cmd_terminal:
	ld b,009h		; initial column position (after prompt)
terminal_loop:
...
; BLOCK 'str_portal' (start 0xfb8c end 0xfb96)
str_portal:
...
do_cr:
	...
	ld a,020h		; space (clear cursor mark)
